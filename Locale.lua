...
ns.L = {
    ...
    STEP_SKIPPED       = "|cff69ccf0Qeasy|r: Videre til næste trin.",
    ...
    HELP = {
        ...
        "  /qeasy xp - vis/skjul session-statistik (XP/time)",
        "  /qeasy items - vis/skjul quest-item-knappen",
        "  /qeasy hero - vis/skjul den store item-knap midt på skærmen",

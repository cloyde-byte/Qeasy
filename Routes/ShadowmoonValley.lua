    ...
    steps = {
        ...
        { label = "The Cipher of Damnation og afslutning", elements = {
                ...
                { kind = "note", coords = { map = 1948, x = 56.0, y = 59.6 }, text = "Sanctum of the Stars / Altar of Sha'tar",
                  note = "Valgfrit: Scryers' Sanctum of the Stars (eller Aldors Altar of Sha'tar) har quests fra 69-70 og dailies - godt sted at starte dit endgame-ry.", optional = true },
                { kind = "ding", level = 70 },
